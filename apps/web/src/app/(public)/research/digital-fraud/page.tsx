          ...
          <main className="flex flex-col gap-24 md:gap-32">
            ...
            <section id="context" className="scroll-mt-32 ">
              <Reveal>
                ...
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  Research Context details for Digital Fraud. This area is currently being investigated. More data and observations will be published as they become available.
                </p>
              </Reveal>
            </section>
            <section id="matters" className="scroll-mt-32 border-t border-border/40 pt-16">
              <Reveal>
                ...
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  Why This Area Matters details for Digital Fraud. This area is currently being investigated. More data and observations will be published as they become available.
                </p>
              </Reveal>
            </section>
            <section id="intends" className="scroll-mt-32 border-t border-border/40 pt-16">
              <Reveal>
                ...
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  What LR Intends to Study details for Digital Fraud. This area is currently being investigated. More data and observations will be published as they become available.
                </p>
              </Reveal>
            </section>
            <section id="questions" className="scroll-mt-32 border-t border-border/40 pt-16">
              <Reveal>
                ...
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  Research Questions details for Digital Fraud. This area is currently being investigated. More data and observations will be published as they become available.
                </p>
              </Reveal>
            </section>
            <section id="open" className="scroll-mt-32 border-t border-border/40 pt-16">
              <Reveal>
                ...
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  Open Questions details for Digital Fraud. This area is currently being investigated. More data and observations will be published as they become available.
                </p>
              </Reveal>
            </section>
            <section id="direction" className="scroll-mt-32 border-t border-border/40 pt-16">
              <Reveal>
                ...
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  Future Research Direction details for Digital Fraud. This area is currently being investigated. More data and observations will be published as they become available.
                </p>
              </Reveal>
            </section>
          </main>
