...
export default function ResearchPage() {
  ...
  const sections = useMemo(() => [
    ...
    { id: "current", title: "Current Research", label: "Current Research" },
    { id: "observations", title: "Initial Observations", label: "Initial Observations" },
    { id: "questions", title: "Research Questions", label: "Research Questions" },
    { id: "direction", title: "Current Direction", label: "Current Direction" },
    { id: "next", title: "Next Research Stage", label: "Next Research Stage" },
  ], []);
          ...
          <main className="flex flex-col gap-24 md:gap-32">
            ...
            <section id="context" className="scroll-mt-32 ">
              <Reveal>
                ...
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  Research Context details for Phishing. This area is currently being investigated. More data and observations will be published as they become available.
                </p>
              </Reveal>
            </section>
            <section id="current" className="scroll-mt-32 border-t border-border/40 pt-16">
              <Reveal>
                <SectionHeader number="01" title="Current Research" />
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  Current Research details for Phishing. This area is currently being investigated. More data and observations will be published as they become available.
                </p>
              </Reveal>
            </section>
            <section id="observations" className="scroll-mt-32 border-t border-border/40 pt-16">
              <Reveal>
                <SectionHeader number="02" title="Initial Observations" />
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  Initial Observations details for Phishing. This area is currently being investigated. More data and observations will be published as they become available.
                </p>
              </Reveal>
            </section>
            <section id="questions" className="scroll-mt-32 border-t border-border/40 pt-16">
              <Reveal>
                ...
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  Research Questions details for Phishing. This area is currently being investigated. More data and observations will be published as they become available.
                </p>
              </Reveal>
            </section>
            <section id="direction" className="scroll-mt-32 border-t border-border/40 pt-16">
              <Reveal>
                <SectionHeader number="04" title="Current Direction" />
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  Current Direction details for Phishing. This area is currently being investigated. More data and observations will be published as they become available.
                </p>
              </Reveal>
            </section>
            <section id="next" className="scroll-mt-32 border-t border-border/40 pt-16">
              <Reveal>
                <SectionHeader number="05" title="Next Research Stage" />
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  Next Research Stage details for Phishing. This area is currently being investigated. More data and observations will be published as they become available.
                </p>
              </Reveal>
            </section>
          </main>
